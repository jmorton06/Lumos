...
vec3 GetMetallic()
{
	return (1.0 - materialProperties.usingMetallicMap) * materialProperties.metallicColour.rgb + materialProperties.usingMetallicMap * texture(u_MetallicMap, fragTexCoord).rgb;
}
