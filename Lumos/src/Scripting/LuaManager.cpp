...
namespace Lumos
{
    ...
    //        "y", &Maths::Vector3::y,
    //        "z", &Maths::Vector3::z,
    //        "Dot", static_cast<float(Maths::Vector3::*)(const Maths::Vector3&) const>(&Maths::Vector3::Dot),
    //        "Cross", static_cast<Maths::Vector3(Maths::Vector3::*)(const Maths::Vector3&) const>(&Maths::Vector3::Cross),
    ...
    //        "ToEuler", &Maths::Quaternion::ToEuler,
    //        "Conjugate", &Maths::Quaternion::Conjugate,
    //        "GenerateW", &Maths::Quaternion::GenerateW,
    //        "Normalize", &Maths::Quaternion::Normalize,
    //        "Normal", &Maths::Quaternion::Normal,
    //        sol::meta_function::addition, sol::overload(
    ...
    //        sol::constructors<Maths::Matrix3(Maths::Vector3, Maths::Vector3, Maths::Vector3), Maths::Matrix3(float, float, float, float, float,float,float,float,float), Maths::Matrix3()>(),
    //        sol::meta_function::index, static_cast<float(Maths::Matrix3::*)(int) const>(&Maths::Matrix3::operator[]),
    //        sol::meta_function::multiplication, sol::overload(
    ...
    //        "Rotation", &Maths::Matrix4::ToQuaternion,
    //        "Translation", &Maths::Matrix4::Translation,

    //        sol::meta_function::index, static_cast<float(Maths::Matrix4::*)(int) const>(&Maths::Matrix4::operator[]),
    //        sol::meta_function::multiplication, sol::overload(
    ...
    void LuaManager::BindImGuiLua(sol::state* solState)
    {
        ...
        imgui["endPopup"] = ImGui::EndPopup;
        imgui["ColumnumnIndex"] = ImGui::ColumnumnIndex;
        imgui["ColumnumnWidth"] =
            sol::overload(ImGui::ColumnumnWidth, []() { return ImGui::ColumnumnWidth(); });
        imgui["setColumnWidth"] = ImGui::SetColumnWidth;
        imgui["ColumnumnOffset"] =
            sol::overload(ImGui::ColumnumnOffset, []() { return ImGui::ColumnumnOffset(); });
        imgui["setColumnOffset"] = ImGui::SetColumnOffset;
        imgui["ColumnumnsCount"] = ImGui::ColumnumnsCount;
