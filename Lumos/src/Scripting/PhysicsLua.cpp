...
namespace Lumos
{
    ...
    class ContactListener : public b2ContactListener
     ...
     void SetBeginFunction(sol::function func) { beginContactFunction = func; };
    ...
    void BindPhysicsLua(sol::state& state)
    {
        ...
        sol::usertype< PhysicsObject2D > physics2D_type = state.new_usertype< PhysicsObject2D >( "PhysicsObject2D", sol::constructors<PhysicsObject2D(const PhysicsObjectParamaters&)>());
        ...
        physics2D_type.set_function( "GetAngle", &PhysicsObject2D::GetAngle );
        physics2D_type.set_function( "GetFriction", &PhysicsObject2D::GetFriction );
