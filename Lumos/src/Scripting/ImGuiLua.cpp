...
void BindImGuiLua(sol::state& solState)
{
	...
	imgui["showStyleEditor"] = sol::overload(ImGui::ShowStyleEditor, []() { ImGui::ShowStyleEditor(); });
	...
	imgui["styleColorsDark"] = sol::overload(ImGui::StyleColorsDark, []() { ImGui::StyleColorsDark(); });
	imgui["styleColorsClassic"] = sol::overload(ImGui::StyleColorsClassic, []() { ImGui::StyleColorsClassic(); });
	imgui["styleColorsLight"] = sol::overload(ImGui::StyleColorsLight, []() { ImGui::StyleColorsLight(); });
	...
	imgui["beginChild"] = sol::overload((bool (*)(const char*, const ImVec2&, bool, ImGuiWindowFlags))ImGui::BeginChild,
		...
		[](const char* _str, const ImVec2& _size, bool _border) { return ImGui::BeginChild(_str, _size, _border); });
	imgui["endChild"] = ImGui::EndChild;

	imgui["isWindowAppearing"] = ImGui::IsWindowAppearing;
	imgui["isWindowCollapsed"] = ImGui::IsWindowCollapsed;
	imgui["isWindowFocused"] = sol::overload(ImGui::IsWindowFocused, []() { return ImGui::IsWindowFocused(); });
	imgui["isWindowHovered"] = sol::overload(ImGui::IsWindowHovered, []() { return ImGui::IsWindowHovered(); });
	...
	imgui["setNextWindowSize"] =
		sol::overload(ImGui::SetNextWindowSize, [](const ImVec2& _size) { ImGui::SetNextWindowSize(_size); });
	...
	imgui["setNextWindowCollapsed"] = sol::overload(
		ImGui::SetNextWindowCollapsed, [](bool _collapsed) { ImGui::SetNextWindowCollapsed(_collapsed); });
	...
	imgui["setWindowFocus"] =
		sol::overload((void (*)(const char*))ImGui::SetWindowFocus, (void (*)())ImGui::SetWindowFocus);
	...
	imgui["setWindowCollapsed"] = sol::overload((void (*)(bool, ImGuiCond))ImGui::SetWindowCollapsed,
		...
		[](const char* _name, bool _collapsed) { ImGui::SetWindowCollapsed(_name, _collapsed); });
	imgui["setWindowFocus"] =
		sol::overload((void (*)())ImGui::SetWindowFocus, (void (*)(const char*))ImGui::SetWindowFocus);
	...
	imgui["pushTextWrapPos"] = sol::overload(ImGui::PushTextWrapPos, []() { ImGui::PushTextWrapPos(); });
	...
	imgui["textColored"] = [](const ImVec4& col, const char* _text) { ImGui::TextColored(col, "%s", _text); };
	...
	imgui["labelText"] = [](const char* _label, const char* _text) { ImGui::LabelText(_label, "%s", _text); };
	...
	imgui["progressBar"] = sol::overload(
		...
		[](float _fraction, const ImVec2& _size_arg) { ImGui::ProgressBar(_fraction, _size_arg); });
	...
	imgui["setNextTreeNodeOpen"] =
		sol::overload(ImGui::SetNextTreeNodeOpen, [](bool _is_open) { ImGui::SetNextTreeNodeOpen(_is_open); });
	...
	imgui["beginMenu"] = sol::overload(ImGui::BeginMenu, [](const char* _label) { return ImGui::BeginMenu(_label); });
	...
	imgui["menuItem"] = sol::overload((bool (*)(const char*, const char*, bool, bool))ImGui::MenuItem,
		...
		[](const char* _label, const char* _shortcut) { return ImGui::MenuItem(_label, _shortcut); },
	...
	imgui["beginPopup"] = sol::overload(ImGui::BeginPopup, [](const char* _str) { return ImGui::BeginPopup(_str); });
	...
	imgui["beginPopupContextWindow"] = sol::overload(
		...
		[](const char* _str, int _mouse_button) { return ImGui::BeginPopupContextWindow(_str, _mouse_button); },
	...
	imgui["openPopupOnItemClick"] = sol::overload(
		ImGui::OpenPopupOnItemClick, [](const char* _name) { return ImGui::OpenPopupOnItemClick(_name); });
	...
	imgui["GetColumnWidth"] = sol::overload(ImGui::GetColumnWidth, []() { return ImGui::GetColumnWidth(); });
	imgui["setColumnWidth"] = ImGui::SetColumnWidth;
	imgui["GetColumnOffset"] = sol::overload(ImGui::GetColumnOffset, []() { return ImGui::GetColumnOffset(); });
	imgui["setColumnOffset"] = ImGui::SetColumnOffset;
	imgui["GetColumnsCount"] = ImGui::GetColumnsCount;

	imgui["beginTabBar"] = sol::overload(ImGui::BeginTabBar, [](const char* _id) { return ImGui::BeginTabBar(_id); });
