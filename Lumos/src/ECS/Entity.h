...
namespace Lumos {
    ...
    public:
		...
		Maths::Transform& GetTransform() { return m_Scene->GetRegistry().get<Maths::Transform>(m_EntityHandle); }
		const Maths::Transform& GetTransform() const { return m_Scene->GetRegistry().get<Maths::Transform>(m_EntityHandle); }

		operator u32 () const { return (u32)m_EntityHandle; }
		operator bool () const { return (u32)m_EntityHandle && m_Scene; }
