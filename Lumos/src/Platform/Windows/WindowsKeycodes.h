...
namespace Lumos
{
	namespace WindowsKeyCodes
	{
		...
		inline u32 WindowsKeyToLumos(u32 key)
		{
			...
			{ KEYBOARD_C, LUMOS_KEY_C},
			{ KEYBOARD_D, LUMOS_KEY_D},
			{ KEYBOARD_E, LUMOS_KEY_E},
			{ KEYBOARD_F, LUMOS_KEY_F},
			{ KEYBOARD_G, LUMOS_KEY_G},
			{ KEYBOARD_H, LUMOS_KEY_H},
			{ KEYBOARD_I, LUMOS_KEY_I},
			{ KEYBOARD_J, LUMOS_KEY_J},
			{ KEYBOARD_K, LUMOS_KEY_K},
			{ KEYBOARD_L, LUMOS_KEY_L},
			{ KEYBOARD_M, LUMOS_KEY_M},
			{ KEYBOARD_N, LUMOS_KEY_N},
			{ KEYBOARD_O, LUMOS_KEY_O},
			{ KEYBOARD_P, LUMOS_KEY_P},
			{ KEYBOARD_Q, LUMOS_KEY_Q},
			{ KEYBOARD_R, LUMOS_KEY_R},
			{ KEYBOARD_S, LUMOS_KEY_S},
			{ KEYBOARD_T, LUMOS_KEY_T},
			{ KEYBOARD_U, LUMOS_KEY_U},
			{ KEYBOARD_V, LUMOS_KEY_V},
			{ KEYBOARD_W, LUMOS_KEY_W},
			{ KEYBOARD_X, LUMOS_KEY_X},
			{ KEYBOARD_Y, LUMOS_KEY_Y},
			{ KEYBOARD_Z, LUMOS_KEY_Z},

			{ KEYBOARD_0, LUMOS_KEY_0},
			{ KEYBOARD_1, LUMOS_KEY_1},
			{ KEYBOARD_2, LUMOS_KEY_2},
			{ KEYBOARD_3, LUMOS_KEY_3},
			{ KEYBOARD_4, LUMOS_KEY_4},
			{ KEYBOARD_5, LUMOS_KEY_5},
			{ KEYBOARD_6, LUMOS_KEY_6},
			{ KEYBOARD_7, LUMOS_KEY_7},
			{ KEYBOARD_8, LUMOS_KEY_8},
			{ KEYBOARD_9, LUMOS_KEY_9},
		
			{ KEYBOARD_SUBTRACT	, LUMOS_KEY_SUBTRACT	},
			{ KEYBOARD_DELETE	, LUMOS_KEY_DELETE		},
			{ KEYBOARD_SPACE	, LUMOS_KEY_SPACE		},
			{ KEYBOARD_LEFT		, LUMOS_KEY_LEFT		},
			{ KEYBOARD_RIGHT	, LUMOS_KEY_RIGHT		},
			{ KEYBOARD_UP		, LUMOS_KEY_UP			},
			{ KEYBOARD_DOWN		, LUMOS_KEY_DOWN		},
