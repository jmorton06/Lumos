...
namespace Lumos::Graphics
{
	...
	AnimatedSprite::AnimatedSprite(const Ref<Texture2D>& texture, const Maths::Vector2& position, const Maths::Vector2& scale, const std::vector<Maths::Vector2>& frames,
