...
namespace Lumos
{
	...
	PointRenderer::PointRenderer(u32 width, u32 height, bool renderToGBuffer, bool clear) : m_IndexCount(0), m_RenderTexture(nullptr), m_Buffer(nullptr), m_Clear(clear)
	{
	...
	void PointRenderer::RenderInternal(Scene* scene)
	{
        LUMOS_PROFILE_FUNC;
