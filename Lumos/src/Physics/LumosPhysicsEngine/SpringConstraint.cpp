...
namespace Lumos
{
	SpringConstraint::SpringConstraint(RigidBody3D* obj1, RigidBody3D* obj2, const Maths::Vector3& globalOnA, const Maths::Vector3& globalOnB, float springConstant, float dampingFactor)
		: m_pObj1(obj1)
		, m_pObj2(obj2)
