...
void B2DebugDraw::DrawPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color)
{
	...
	for (int32 i = 0; i < vertexCount; ++i)
	{
        ...
        DebugRenderer::DrawHairLine({p1.x, p1.y, 0.0f}, {p2.x, p2.y, 0.0f}, {color.r, color.g, color.b, color.a });
        p1 = p2;
	}
}
...
void B2DebugDraw::DrawSolidPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& color)
{
     ...
     {
        DebugRenderer::DrawTriangle({vertices[0].x, vertices[0].y, 0.0f}, {vertices[2].x, vertices[2].y, 0.0f},{vertices[1].x, vertices[1].y, 0.0f}, {fillColor.r, fillColor.g, fillColor.b, fillColor.a });
     }
...
void B2DebugDraw::DrawCircle(const b2Vec2& center, float radius, const b2Color& color)
{
	 ...
	 for (int32 i = 0; i < k_segments; ++i)
	 {
         ...
         DebugRenderer::DrawHairLine({v1.x, v1.y, 0.0f}, {v2.x, v2.y, 0.0f}, {color.r, color.g, color.b, color.a });
         r1 = r2;
         v1 = v2;
	 }
}
...
void B2DebugDraw::DrawSolidCircle(const b2Vec2& center, float radius, const b2Vec2& axis, const b2Color& color)
{
	 ...
	 for (int32 i = 0; i < k_segments; ++i)
	 {
         ...
         r2.y = sinInc * r1.x + cosInc * r1.y;
	 	 b2Vec2 v2 = center + radius * r2;
         DebugRenderer::DrawTriangle({v0.x, v0.y, 0.0f}, {v2.x, v2.y, 0.0f},{v1.x, v1.y, 0.0f}, {fillColor.r, fillColor.g, fillColor.b, fillColor.a });
         r1 = r2;
         v1 = v2;
	 }
...
{
    DebugRenderer::DrawPoint({p.x, p.y}, size, {color.r, color.g, color.b, color.a});
}
