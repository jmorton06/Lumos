...
namespace Lumos
{
    ...
    public:
        ...
        T* end() { return m_Data + m_CurrentIndex; }
        const T* begin() const { return m_Data; }
        const T* end() const { return m_Data + m_CurrentIndex; }
    ...
    Vector<T>::Vector(Vector<T>&& other) noexcept
        : m_Data(other.m_Data), m_Size(other.m_Size), m_CurrentIndex(other.m_CurrentIndex)
    {
    }
    ...
    template<class T>
    Vector<T>::Vector(size_t size, T initial): m_Size(size), m_CurrentIndex(size),
