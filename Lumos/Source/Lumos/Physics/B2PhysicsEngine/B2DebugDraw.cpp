...
namespace Lumos
{
    ...
    void B2DebugDraw::DrawPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& colour)
    {
        ...
        for(int32 i = 0; i < vertexCount; ++i)
        {
            ...
            DebugRenderer::DrawHairLine({ p1.x, p1.y, 0.0f }, { p2.x, p2.y, 0.0f }, false, { colour.r, colour.g, colour.b, colour.a });
            p1 = p2;
        }
    }
    ...
    void B2DebugDraw::DrawSolidPolygon(const b2Vec2* vertices, int32 vertexCount, const b2Color& colour)
    {
        ...
        {
            DebugRenderer::DrawTriangle({ vertices[0].x, vertices[0].y, 0.0f }, { vertices[2].x, vertices[2].y, 0.0f }, { vertices[1].x, vertices[1].y, 0.0f }, false, { fillColour.r, fillColour.g, fillColour.b, fillColour.a });
        }
    ...
    void B2DebugDraw::DrawCircle(const b2Vec2& center, float radius, const b2Color& colour)
    {
        ...
        for(int32 i = 0; i < k_segments; ++i)
        {
            ...
            DebugRenderer::DrawHairLine({ v1.x, v1.y, 0.0f }, { v2.x, v2.y, 0.0f }, false, { colour.r, colour.g, colour.b, colour.a });
            r1 = r2;
            v1 = v2;
        }
    }
    ...
    void B2DebugDraw::DrawTransform(const b2Transform& xf)
    {
        ...
        DebugRenderer::DrawHairLine({ p1.x, p1.y, 0.0f }, { p2.x, p2.y, 0.0f }, false, { red.r, red.g, red.b, red.a });

        p2 = p1 + k_axisScale * xf.q.GetYAxis();
        DebugRenderer::DrawHairLine({ p1.x, p1.y, 0.0f }, { p2.x, p2.y, 0.0f }, false, { green.r, green.g, green.b, green.a });
    }
