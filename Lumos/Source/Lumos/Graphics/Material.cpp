...
namespace Lumos::Graphics
{
    ...
    void Material::LoadPBRMaterial(const std::string& name, const std::string& path, const std::string& extension)
    {
        ...
        auto params = Graphics::TextureParameters(Graphics::TextureFormat::R8G8B8A8_Unorm, Graphics::TextureFilter::LINEAR, Graphics::TextureFilter::LINEAR, Graphics::TextureWrap::CLAMP_TO_EDGE);
