    ...
    namespace Graphics
    {
        ...
        void Renderer::LoadEngineShaders(bool loadEmbeddedShaders)
        {
            ...
            if(loadEmbeddedShaders)
            {
                ...
                shaderLibrary->AddResource("EnvironmentIrradiance", SharedPtr<Graphics::Shader>(Graphics::Shader::CreateFromEmbeddedArray(spirv_ScreenPassvertspv.data(), spirv_ScreenPassvertspv_size, spirv_EnvironmentIrradiancefragspv.data(), spirv_EnvironmenMipFiltertIrradiancefragspv_size)));
                shaderLibrary->AddResource("EnvironmentMipFilter", SharedPtr<Graphics::Shader>(Graphics::Shader::CreateFromEmbeddedArray(spirv_ScreenPassvertspv.data(), spirv_ScreenPassvertspv_size, spirv_EnvironmentMipFilterfragspv.data(), spirv_EnvironmentIrradiancefragspv_size)));
