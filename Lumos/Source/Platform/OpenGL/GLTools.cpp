...
namespace Lumos
{
	namespace Graphics
	{
		...
		u32 GLTools::TextureWrapToGL(const TextureWrap wrap)
		{
			switch (wrap)
			{
		...
		u32 GLTools::StencilTypeToGL(const StencilType type)
		{
			switch (type)
			{
		...
		u32 GLTools::RendererBufferToGL(u32 buffer)
		{
			u32 result = 0;
		...
		u32 GLTools::RendererBlendFunctionToGL(RendererBlendFunction function)
		{
			switch (function)
			{
		...
		u32 GLTools::DataTypeToGL(DataType dataType)
		{
			switch (dataType)
			{
