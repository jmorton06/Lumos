...
#define HAS_FEATURE_TEXTURE_GATHER
// ES 3.0 does not have gather though
#if defined(HAS_FEATURE_TEXTURE_GATHER)
...
void main()
{
	...
	highp vec2 texelCenter    = outTexCoord.xy;
    highp vec2 texelMaxCorner = outTexCoord.xy + pixel_offset * 0.5;
    highp vec2 texelMinCorner = outTexCoord.xy - pixel_offset * 0.5;

    outColour = fxaa(
                texelCenter,
                vec4(texelMinCorner, texelMaxCorner),
                u_Texture,
                pixel_offset,           // FxaaFloat4 fxaaConsoleRcpFrameOpt,
                2.0 * pixel_offset,     // FxaaFloat4 fxaaConsoleRcpFrameOpt2,
